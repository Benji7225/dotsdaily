...
export const iPhoneGenerations: Generation[] = [
  {
    ...
    variants: {
      standard: {
        width: 393,
        height: 852,
        safeArea: { top: Math.round(852 * 0.30), bottom: Math.round(852 * 0.15), left: Math.round(393 * 0.08), right: Math.round(393 * 0.08) },
      },
      plus: {
        width: 430,
        height: 932,
        safeArea: { top: Math.round(932 * 0.30), bottom: Math.round(932 * 0.15), left: Math.round(430 * 0.08), right: Math.round(430 * 0.08) },
      },
      pro: {
        width: 402,
        height: 874,
        safeArea: { top: Math.round(874 * 0.30), bottom: Math.round(874 * 0.15), left: Math.round(402 * 0.08), right: Math.round(402 * 0.08) },
      },
      'pro-max': {
        width: 430,
        height: 932,
  ...
  },
  {
    ...
    variants: {
      standard: {
        width: 390,
        height: 844,
        safeArea: { top: Math.round(844 * 0.30), bottom: Math.round(844 * 0.15), left: Math.round(390 * 0.08), right: Math.round(390 * 0.08) },
      },
      plus: {
        width: 428,
        height: 926,
        safeArea: { top: Math.round(926 * 0.30), bottom: Math.round(926 * 0.15), left: Math.round(428 * 0.08), right: Math.round(428 * 0.08) },
      },
      pro: {
        width: 393,
        height: 852,
  ...
  },
  {
    ...
    variants: {
      mini: {
        width: 375,
        height: 812,
        safeArea: { top: Math.round(812 * 0.30), bottom: Math.round(812 * 0.15), left: Math.round(375 * 0.08), right: Math.round(375 * 0.08) },
      },
      standard: {
        width: 390,
        height: 844,
