      ...
      <section className="pt-20 pb-32 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h1 className="text-5xl md:text-7xl font-bold text-black mb-6 leading-tight whitespace-pre-line">
              {t('home.hero.title')}
            </h1>
        ...
        <div className="container mx-auto max-w-6xl px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8">
              ...
              <h3 className="text-2xl font-bold text-black mb-3">{t('home.modes.year.title')}</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center p-8">
              ...
              <h3 className="text-2xl font-bold text-black mb-3">{t('home.modes.life.title')}</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center p-8">
              ...
              <h3 className="text-2xl font-bold text-black mb-3">{t('home.modes.goal.title')}</h3>
              <p className="text-gray-600">
        ...
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <div className="space-y-6">
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              <h3 className="text-lg font-bold text-black mb-2">{t('home.faq.q1.q')}</h3>
              <p className="text-gray-600">
                {t('home.faq.q1.a')}
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              <h3 className="text-lg font-bold text-black mb-2">{t('home.faq.q2.q')}</h3>
              <p className="text-gray-600">
                {t('home.faq.q2.a')}
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              <h3 className="text-lg font-bold text-black mb-2">{t('home.faq.q3.q')}</h3>
              <p className="text-gray-600">
                {t('home.faq.q3.a')}
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              <h3 className="text-lg font-bold text-black mb-2">{t('home.faq.q4.q')}</h3>
              <p className="text-gray-600">
                {t('home.faq.q4.a')}
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              <h3 className="text-lg font-bold text-black mb-2">{t('home.faq.q5.q')}</h3>
              <p className="text-gray-600">
                {t('home.faq.q5.a')}
              </p>
            </div>
