        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 mb-8">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              DotsDaily a été créé avec une conviction simple : <strong>visualiser le temps nous aide à mieux le vivre</strong>.
            </p>
            <p className="text-slate-600 leading-relaxed mb-4">
            ...
            <p className="text-slate-600 leading-relaxed">
              DotsDaily transforme votre écran de verrouillage en un rappel visuel constant de votre progression dans le temps.
          ...
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl p-8 text-white mb-8">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              DotsDaily s'inspire du concept de "Life in Weeks" popularisé par Tim Urban de Wait But Why.
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 mb-8">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              DotsDaily est 100% gratuit et le restera toujours. Nous croyons que tout le monde devrait avoir accès
